	...
	<form method="POST" action="/www/member/joinProc.van" enctype="multipart/form-data">     
		<ul class="ulcl w3-margin-bottom w3-padding">
			<li id="idli">
				...
				<input type="text" id="id" name="m_Id" required class="">
				<input type="button" id="btn" value="idCheck" class="w3-button w3-left" style="width: 150px; height: 30px; padding: 0px;">
			<p class="" id="id_check" ></p>
			</li>
			
			<li><label for="pw">Password</label><input type="password" id="pw" name="m_Pw"  required >
			...
			<li><label for="name">Name</label><input type="text" id="name" name="m_Name"  required >
			<p class="pcl" id="name_check"></p></li>
			
			<li><label for="email">E-mail</label><input type="text" id="mail" name="m_Mail"  required >
			<p class="pcl" id="email_check"></p></li>
			
			<li><label for="num">Phone Number</label><input type="text" id="tel" name="m_Tel" placeholder="예] 010-1111-1111" required >
			...
			<li class="w3-margin-bottom">
				...
				<div class="w3-row w3-margin-bottom">
					...
					<div class="w3-col m4">
						<span><input class="w3-col m2 w3-radio gen" type="radio" name="m_gen" value="M" > 남 자</span>
					</div>
					<div class="w3-col m4 ">
						<span><input class="w3-col m2 w3-radio gen" type="radio" name="m_gen" value="F" > 여 자</span>
					</div>
				</div>
			...
			<li id="avtChoice">
				...
				<div class="w3-col avtM">
					<div class="w3-col m4">
						<input type="radio" name="m_avt" value="11">
						<div>
